/* drivers/sharp/shtps/sy3000/tm2955-001/shtps_cfg_tm2955-001.h
 *
 ...
 *
 */
#ifndef __SHTPS_CFG_TM2955_001_H__
#define __SHTPS_CFG_TM2955_001_H__
...
#define SHTPS_WARTER_GHOST_REJECTION_ENABLE
#define SHTPS_WARTER_CLING_REJECTION_ENABLE
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_LPWG_TX_CLIP_LO, 				0x43);
	SHTPS_PARAM_DEF( SHTPS_LPWG_TX_CLIP_HI, 				0x43);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_AREA_THRESH_X,	93);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_AREA_THRESH_Y,	728);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_DISTANCE,			598);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO,			107);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO_2,		100);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_EFFECT_TIME,		762);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_TOP_AREA_THRESH_X,		199);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_TOP_AREA_THRESH_Y,		32);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_TOP_SIDE_AREA_THRESH_X,	75);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_TOP_SIDE_AREA_THRESH_Y,	81);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_TOP_AREA_THRESH_Z,		20);
	SHTPS_PARAM_DEF( SHTPS_EDGE_FAIL_TOUCH_REJECT_TOP_AREA_THRESH_ZW_RATIO,	91);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_GRIP_FAIL_FLICK_REJECT_AREA, 		350);
	SHTPS_PARAM_DEF( SHTPS_GRIP_FAIL_FLICK_REJECT_W_THRESH, 	40);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_DRAG_SMOOTH_COUNT_UP_STEP,				10);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_PINCH_FAIL_RESPONSE_REJECT_ENABLE, 			0);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_WARTER_GHOST_REJECT_ENABLE, 					1);
	SHTPS_PARAM_DEF( SHTPS_WARTER_GHOST_REJECT_GHOST_THRESH,		 	85);
	SHTPS_PARAM_DEF( SHTPS_WARTER_GHOST_REJECT_GHOST_THRESH_2,		 	100);
	SHTPS_PARAM_DEF( SHTPS_WARTER_GHOST_REJECT_GHOST_THRESH_CHG_VAL,	50);
	SHTPS_PARAM_DEF( SHTPS_WARTER_GHOST_REJECT_RETURN_THRESH,	 		200);
	SHTPS_PARAM_DEF( SHTPS_WARTER_GHOST_REJECT_COUNT_MAX, 				50);
	SHTPS_PARAM_DEF( SHTPS_WARTER_GHOST_REJECT_COUNT_CLEAR_TIME_THRESH,	100);
	SHTPS_PARAM_DEF( SHTPS_WARTER_GHOST_REJECT_COUNT_CLEAR_POS_THRESH, 	300);

	#if defined( SHTPS_LOG_DEBUG_ENABLE )
		SHTPS_PARAM_DEF( SHTPS_WARTER_GHOST_REJECT_LOG_ENABLE, 	0);
	    #define	SHTPS_LOG_DBG_WARTER_GHOST_PRINT(...)				\
	        if(SHTPS_WARTER_GHOST_REJECT_LOG_ENABLE != 0){	\
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_WARTER_CLING_REJECT_ENABLE, 					1);
	SHTPS_PARAM_DEF( SHTPS_WARTER_CLING_REJECT_Z_THRESH,		 		7);
	SHTPS_PARAM_DEF( SHTPS_WARTER_CLING_REJECT_RATIO_THRESH,		 	50);
	SHTPS_PARAM_DEF( SHTPS_WARTER_CLING_REJECT_COUNT_MAX, 				180);
	SHTPS_PARAM_DEF( SHTPS_WARTER_CLING_REJECT_COUNT_CLEAR_TIME_THRESH,	100);

	#if defined( SHTPS_LOG_DEBUG_ENABLE )
		SHTPS_PARAM_DEF( SHTPS_WARTER_CLING_REJECT_LOG_ENABLE, 	0);
	    #define	SHTPS_LOG_DBG_WARTER_CLING_PRINT(...)				\
	        if(SHTPS_WARTER_CLING_REJECT_LOG_ENABLE != 0){	\
...
/* -----------------------------------------------------------------------------------
 */
#endif /* __SHTPS_CFG_TM2955_001_H__ */
