...
#define SHGRIP_IOCTL_SET_BK_ADJUST			_IOW (SHGRIP_IOC_MAGIC, 36, struct shgrip_sens_setting_params)
...
struct shgrip_mode_state {
	...
	unsigned char scmsa_mode;
	unsigned char scmsaval_mode;
	unsigned char ch0_th4_hys;
	unsigned char ch2_th4_hys;
	unsigned char ch0_th5_hys;
	unsigned char ch2_th5_hys;
	unsigned char pcovrc_mode;
	unsigned char w_quick;
};
...
#if 0
struct shgrip_th5_s_cnt_ch0 {
	unsigned char high_val;
	unsigned char low_val;
};

struct shgrip_th5_s_cnt_ch2 {
	unsigned char high_val;
	unsigned char low_val;
};
#endif
...
#if 0
struct shgrip_th5_t_cnt_ch0 {
	unsigned char high_val;
	unsigned char low_val;
};

struct shgrip_th5_t_cnt_ch2 {
	unsigned char high_val;
	unsigned char low_val;
};
#endif
